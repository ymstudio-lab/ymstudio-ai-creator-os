(function (root, factory) {
  ...
  const demoItems = [
    ...
    },
    {
      ...
      performanceNotes: "로컬 워크플로우 설명으로 연결하기 좋은 주제.",
    },
    {
      title: "AI tutorial channel planning poll",
      format: "community",
      channel: "YMSTUDIO AI",
      niche: "Creator planning poll",
      uploadDate: "2026-05-30",
      status: "scheduled",
      scriptOutline: "시청자에게 템플릿, 점검표, 튜토리얼, 워크플로우 예시 중 어떤 공개 예제를 원하는지 묻는 커뮤니티 글.",
      titleVariants: ["다음 공개 예제를 골라주세요", "AI 채널은 무엇을 먼저 보여줘야 할까요?", "투표: 템플릿, 점검표, 튜토리얼"],
